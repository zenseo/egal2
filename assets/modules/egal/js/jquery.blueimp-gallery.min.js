!function (t) {
    ...
    return t.extend(e.prototype, {options: {container: "#blueimp-gallery", slidesContainer: "div", titleElement: "h3", displayClass: "blueimp-gallery-display", controlsClass: "blueimp-gallery-controls", singleClass: "blueimp-gallery-single", leftEdgeClass: "blueimp-gallery-left", rightEdgeClass: "blueimp-gallery-right", playingClass: "blueimp-gallery-playing", slideClass: "slide", slideLoadingClass: "slide-loading", slideErrorClass: "slide-error", slideContentClass: "slide-content", toggleClass: "toggle", prevClass: "prev", nextClass: "next", closeClass: "close", playPauseClass: "play-pause", typeProperty: "type", titleProperty: "title", urlProperty: "href", clearSlides: !0, stretchImages: !1, toggleControlsOnReturn: !0, toggleSlideshowOnSpace: !0, enableKeyboardNavigation: !0, closeOnEscape: !0, closeOnSlideClick: !0, closeOnSwipeUpOrDown: !0, emulateTouchEvents: !0, hidePageScrollbars: !0, disableScroll: !0, carousel: !1, continuous: !0, unloadElements: !0, startSlideshow: !1, slideshowInterval: 5e3, index: 0, preloadRange: 2, transitionSpeed: 400, slideshowTransitionSpeed: void 0, event: void 0, onopen: void 0, onslide: void 0, onslideend: void 0, onslidecomplete: void 0, onclose: void 0}, carouselOptions: {hidePageScrollbars: !1, toggleControlsOnReturn: !1, toggleSlideshowOnSpace: !1, enableKeyboardNavigation: !1, closeOnEscape: !1, closeOnSlideClick: !1, closeOnSwipeUpOrDown: !1, disableScroll: !1, startSlideshow: !0}, support: function (e) {
        ...
        window.clearTimeout(this.timeout), this.interval = t || this.options.slideshowInterval, this.elements[this.index] > 1 && (this.timeout = this.setTimeout(this.slide, [this.index + 1, this.options.slideshowTransitionSpeed], this.interval)), this.container.addClass(this.options.playingClass)
    }, pause: function () {
        window.clearTimeout(this.timeout), this.interval = null, this.container.removeClass(this.options.playingClass)
    }, add: function (t) {
        var e;
        for (this.list = this.list.concat(t), this.num = this.list.length, this.num > 2 && null === this.options.continuous && (this.options.continuous = !0, this.container.removeClass(this.options.leftEdgeClass)), this.container.removeClass(this.options.rightEdgeClass).removeClass(this.options.singleClass), e = this.num - t.length; e < this.num; e += 1)this.addSlide(e), this.positionSlide(e);
        this.positions.length = this.num, this.initSlides(!0)
    }, resetSlides: function () {
        this.slidesContainer.empty(), this.slides = []
    }, close: function () {
        var t = this.options;
        this.destroyEventListeners(), this.pause(), this.container[0].style.display = "none", this.container.removeClass(t.displayClass).removeClass(t.singleClass).removeClass(t.leftEdgeClass).removeClass(t.rightEdgeClass), t.hidePageScrollbars && (document.body.style.overflow = this.bodyOverflowStyle), this.options.clearSlides && this.resetSlides(), this.options.onclose && this.options.onclose.call(this)
    }, circle: function (t) {
        return(this.num + t % this.num) % this.num
    }, move: function (t, e, i) {
        this.translateX(t, e, i), this.positions[t] = e
    }, translate: function (t, e, i, s) {
        var n = this.slides[t].style, o = this.support.transition, l = this.support.transform;
        n[o.name + "Duration"] = s + "ms", n[l.name] = "translate(" + e + "px, " + i + "px)" + (l.translateZ ? " translateZ(0)" : "")
    }, translateX: function (t, e, i) {
        this.translate(t, e, 0, i)
    }, translateY: function (t, e, i) {
        this.translate(t, 0, e, i)
    }, animate: function (t, e, i) {
        if (!i)return this.slidesContainer[0].style.left = e + "px", void 0;
        var s = this, n = (new Date).getTime(), o = window.setInterval(function () {
            var l = (new Date).getTime() - n;
            return l > i ? (s.slidesContainer[0].style.left = e + "px", s.ontransitionend(), window.clearInterval(o), void 0) : (s.slidesContainer[0].style.left = (e - t) * (Math.floor(100 * (l / i)) / 100) + t + "px", void 0)
        }, 4)
        ...
        t.which && 1 === t.which && (t.preventDefault(), (t.originalEvent || t).touches = [
        ...
        var t, e, i, s, n, o = this.index, l = this.options.transitionSpeed, r = this.slideWidth, a = Number(Date.now() - this.touchStart.time) < 250, h = a && Math.abs(this.touchDelta.x) > 20 || Math.abs(this.touchDelta.x) > r / 2, d = !o && this.touchDelta.x > 0 || o === this.num - 1 && this.touchDelta.x < 0, c = !h && this.options.closeOnSwipeUpOrDown && (a && Math.abs(this.touchDelta.y) > 20 || Math.abs(this.touchDelta.y) > this.slideHeight / 2);
        this.options.continuous && (d = !1), t = this.touchDelta.x < 0 ? -1 : 1, this.isScrolling ? c ? this.close() : this.translateY(o, 0, l) : h && !d ? (e = o + t, i = o - t, s = r * t, n = -r * t, this.options.continuous ? (this.move(this.circle(e), s, 0), this.move(this.circle(o - 2 * t), n, 0)) : e >= 0 && e < this.num && this.move(e, s, 0), this.move(o, this.positions[o] + s, l), this.move(this.circle(i), this.positions[this.circle(i)] + s, l), o = this.circle(i), this.onslide(o)) : this.options.continuous ? (this.move(this.circle(o - 1), -r, l), this.move(o, 0, l), this.move(this.circle(o + 1), r, l)) : (o && this.move(o - 1, -r, l), this.move(o, 0, l), o < this.num - 1 && this.move(o + 1, r, l))
        ...
        var s, n, o, l = this, r = this.imagePrototype.cloneNode(!1), a = e, h = this.options.stretchImages && this.support.backgroundSize && this.support.backgroundSize.contain, d = function (e) {
            if (!s) {
                if (e = {type: e.type, target: n}, !n.parentNode)return l.setTimeout(d, [e]);
                s = !0, t(r).off("load error", d), h && "load" === e.type && (n.style.background = 'url("' + a + '") center no-repeat', n.style.backgroundSize = "contain"), i(e)
            }
        };
        return"string" != typeof a && (a = this.getItemProperty(e, this.options.urlProperty), o = this.getItemProperty(e, this.options.titleProperty)), h ? n = this.elementPrototype.cloneNode(!1) : (n = r, r.draggable = !1), o && (n.title = o), t(r).on("load error", d), r.src = a, n
        ...
        for (e = 0; i > e; e += 1)s += e * (0 === e % 2 ? -1 : 1), s = this.circle(s), this.loadElement(s)
    }, unloadElements: function (t) {
        var e, i, s;
        for (e in this.elements)this.elements.hasOwnProperty(e) && (s = Math.abs(t - e), s > this.options.preloadRange && s + this.options.preloadRange < this.num && (i = this.slides[e], i.removeChild(i.firstChild), delete this.elements[e]))
    }, addSlide: function (t) {
        ...
        return e.replace(/\[(?:'([^']+)'|"([^"]+)"|(\d+))\]|(?:(?:^|\.)([^\.\[]+))/g, function (e, i, s, n, o) {
            var l = o || i || s || n && parseInt(n, 10);
            e && t && (t = t[l])
        }), t
    }, getItemProperty: function (t, e) {
        return t[e] || t.getAttribute && t.getAttribute("data-" + e) || this.getNestedProperty(t, e)
        ...
        return this.container = t(this.options.container), this.container.length ? (this.slidesContainer = this.container.find(this.options.slidesContainer), this.slidesContainer.length ? (this.titleElement = this.container.find(this.options.titleElement), this.options.hidePageScrollbars && (this.bodyOverflowStyle = document.body.style.overflow, document.body.style.overflow = "hidden"), 1 === this.num && this.container.addClass(this.options.singleClass), this.container[0].style.display = "block", this.initSlides(), this.container.addClass(this.options.displayClass), void 0) : !1) : !1
    ...
    return t.extend(e.prototype, {getFullScreenElement: function () {
    ...
    var i = e.prototype.initSlides, s = e.prototype.addSlide, n = e.prototype.resetSlides, o = e.prototype.handleClick, l = e.prototype.handleSlide, r = e.prototype.close;
    return t.extend(e.prototype, {createIndicator: function (e) {
        var i, s, n = this.indicatorPrototype.cloneNode(!1), o = this.getItemProperty(e, this.options.titleProperty), l = this.options.thumbnailProperty;
        return this.options.thumbnailIndicators && (s = e.getElementsByTagName && t(e).find("img")[0], s ? i = s.src : l && (i = this.getItemProperty(e, l)), i && (n.style.backgroundImage = 'url("' + i + '")')), o && (n.title = o), n
    ...
    "use strict";
    return t.extend(e.prototype.options, {videoContentClass: "video-content", videoLoadingClass: "video-loading", videoPlayingClass: "video-playing", videoPosterProperty: "poster", videoSourcesProperty: "sources"}), e.prototype.videoFactory = function (e, i) {
        var s, n, o, l, r, a = this, h = this.options, d = this.elementPrototype.cloneNode(!1), c = t(d), u = [
            {type: "error", target: d}
        ], p = document.createElement("video"), m = this.getItemProperty(e, h.urlProperty), g = this.getItemProperty(e, h.typeProperty), f = this.getItemProperty(e, h.titleProperty), y = this.getItemProperty(e, h.videoPosterProperty), v = this.getItemProperty(e, h.videoSourcesProperty);
        if (c.addClass(h.videoContentClass), f && (d.title = f), p.canPlayType)if (m && g && p.canPlayType(g))p.src = m; else if (v)for ("string" == typeof v && (v = t.parseJSON(v)); v && v.length;)if (n = v.shift(), m = this.getItemProperty(n, h.urlProperty), g = this.getItemProperty(n, h.typeProperty), m && g && p.canPlayType(g)) {
            p.src = m;
            break
        }
        return y && (p.setAttribute("poster", y), s = this.imagePrototype.cloneNode(!1), t(s).addClass(h.toggleClass), s.src = y, s.draggable = !1, d.appendChild(s)), o = document.createElement("a"), o.setAttribute("target", "_blank"), o.setAttribute("download", f), o.href = m, p.src && (p.controls = !0, t(p).on("error",function () {
            a.setTimeout(i, u)
        }).on("pause",function () {
            l = !1, c.removeClass(a.options.videoLoadingClass).removeClass(a.options.videoPlayingClass), r && a.container.addClass(a.options.controlsClass), a.interval && a.play()
        }).on("playing",function () {
            l = !1, c.removeClass(a.options.videoLoadingClass).addClass(a.options.videoPlayingClass), a.container.hasClass(a.options.controlsClass) ? (r = !0, a.container.removeClass(a.options.controlsClass)) : r = !1
        }).on("play", function () {
            window.clearTimeout(a.timeout), l = !0, c.addClass(a.options.videoLoadingClass)
        }), t(o).on("click", function (t) {
            t.preventDefault(), l ? p.pause() : p.play()
        }), d.appendChild(p)), d.appendChild(o), this.setTimeout(i, [
            {type: "load", target: d}
        ]), d
    }, e
}), function (t) {
    ...
    "use strict";
    t(document.body).on("click", "[data-gallery]", function (i) {
        var s = t(this).data("gallery"), n = t(s), o = n.length && n || t(e.prototype.options.container), l = t.extend(o.data(), {container: o[0], index: this, event: i, onopen: function () {
            o.data("gallery", this).trigger("open", arguments)
        }, onslide: function () {
            ...
            o.trigger("close").removeData("gallery")
        }}), r = t('[data-gallery="' + s + '"]');
