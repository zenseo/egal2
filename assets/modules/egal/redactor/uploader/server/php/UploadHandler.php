...
//$array=array('thumb'=>"asdf",'image'=>'fdsa');
        $array=array();
//        foreach ($response['files'] as $value) {
//            $array['image']=$value['url'];
////            $array['thumb'] = $value['url'];
////            $array['image'] = $value['url'];
//
//        }
        foreach ($response['files'] as $key =>$value) {
           $array[$key]['thumb'] = $value->url;
            $array[$key]['image'] = $value->url;
        }
...
//        return $this->generate_response($array, $print_response);
    ...
    public function post($print_response = true) {
        ...
        $array = array('filelink' => $files[0]->url);
